...
class PlaceholderUnit extends React.Component{
    ...
    render(){
        ...
        return(compose(connectDropTarget)(
            <div  className={"empty-unit"} style={{minHeight:100,maxWidth:unitWidth,minWidth:unitWidth,border:isHovering?"2px solid red":undefined,flexGrow:{credit},userSelect:"none",background:canDrop?"#adff6d":"#b2ccff",boxShadow: "rgba(0, 0, 0, 0.12) 0px 1px 6px, rgba(0, 0, 0, 0.12) 0px 1px 4px"}}>
                {placeholderText}<br/>
                {unitCode}<br/>
...
export default compose(connect(mapStateToProps,{removeUnit,setIsUnitsMenuOpen,removeUnitFromPlaceholder,addUnitCodeToPlaceholder}),DropTarget("Unit",PlaceholderUnitTargetDrop,collectDrop))(PlaceholderUnit)